...
export abstract class ServiceExtension {
    ...
    /**
     * Once the service has been created and connected, this hook is
     * called for each extension to give it a chance to set the remaining details
     * such as security groups rules, etc
     *
     * @param service - The service.
     */
    // @ts-ignore
    public resolveServiceDependencies(service: Service) {
    }
}
